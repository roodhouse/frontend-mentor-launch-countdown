    ...
    <>
        <div id="minContainer" className='w-[70px] h-[71px]'>
          <div id="minSvgContainer" className='mb-[9px]'>
            <svg id="minSvg" className='' width="70" height="71" viewBox="0 0 70 71" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_0_79)">
                <rect width="70" height="71" rx="8" fill="#191A23"/>
                <rect width="70" height="66.2667" rx="4" fill="#343650"/>
                <text id='minText' x='17%' y='65%' className='animate__animated animate__flipInX fill-softRed font-["Red_Hat_Text"] text-4xl leading-[71px] font-bold tracking-[-1.08px]'>{minutes}</text>
